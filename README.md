# Krishan RHCSA v9 Exact-Paper Simulator

> **Private custom build:** Exam Mode is locked to the 21 questions in the
> supplied RHEL 9 practice paper (15 for Node 1 and 6 for Node 2). It does not
> draw questions from the upstream random catalogue. See [EXACT_EXAM.md](EXACT_EXAM.md).
